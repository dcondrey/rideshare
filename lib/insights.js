...
export function byDirection() {
  return /** @type {{ direction: string, kind: string, c: number }[]} */ (
    db
      .prepare(
...
export function byDate() {
  return /** @type {{ date: string, kind: string, c: number }[]} */ (
    db
      .prepare(
...
export function unmetDemand() {
  return /** @type {{ date: string, airport: string, direction: string, c: number }[]} */ (
    db
      .prepare(
